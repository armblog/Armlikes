    ...
    request.send();
            ...
            function parseXml(xml) {
                ...
                for (i = 0; i < myArray.length; i++) {
                    $('<a target="_blank" href=' + myArray[i].url + '><span style="display:none;" data-id=' + i + ' class="article"><img class="thumb"></img><span class="img_h"/><span class="place">' + (i + 1) + '</span><span class="likes">' + myArray[i].likes + '</span><span class="title"><span>' + myArray[i].title + '</span><span style="display:none;" class="category">'+ myArray[i].category + '</span></span></span></a>').appendTo('#content');
